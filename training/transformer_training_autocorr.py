...
def transformer_train_autocorr(num_epochs, num_patients, batch_size, hpc=False):
    ...
    plt.savefig('./figures/histogram_autocorr_train.png', bbox_inches='tight')
    plt.close()
    ...
    plt.savefig('./figures/histogram_autocorr_val.png', bbox_inches='tight')
    plt.close()
    ...
    plt.legend()
    plt.savefig('./figures/model_density_autocorr.png', bbox_inches='tight')
    plt.close()
